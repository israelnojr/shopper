...
@section('content')
    <h2 class="title text-center">Hot Products</h2>
        @foreach($publishedProduct as $product)
            <div class="col-sm-4">
                <div class="product-image-wrapper">
                    <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{URL::to($product->product_image)}}" alt="{{$product->product_name}}" style="height:250px" />
                    ...
                    <div class="choose">
                        <ul class="nav nav-pills nav-justified">
                            <li><a href="{{URL::to('/product-by-brand/'.$product->manufacturer_id)}}"><i class="fa fa-plus-square"></i>{{$product->manufacturer_name}}</a></li>
